...
namespace fromshot_api.Controllers
{
    ...
    public class AuthController(IAuthService authService, EnvironmentConfig connectionStrings) : ControllerBase
    {
        private readonly IAuthService _authService = authService;
        private readonly EnvironmentConfig _connectionStrings = connectionStrings;  
